class Menu extends HTMLElement {
    constructor() {
        ...
        <ul class="sidebar__lista container">
            ...
            <a class="sidebar__enlace" href="actividad.html">Módulo 1. Actividades de aprendizaje <span id="ident6" class="identificador2"> 6 </span></a>
            </li>
            ...
            <li class="sidebar__elemento sangria-menu">
            <a class="sidebar__enlace" href="modulo-2-actividad.html">Módulo 2. Actividades de aprendizaje <span id="ident8" class="identificador2"> 8 </span> </a>
            </li>
