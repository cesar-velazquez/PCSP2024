document.addEventListener("DOMContentLoaded", function () {
    ...
    let section11 = function () {
        let element = document.getElementById('section11M3');
        PositionTop100(element);
    }

    let section12 = function () {
        let element = document.getElementById("section12M3");
        PositionTop100(element);
    }

    let section13 = function () {
        let element = document.getElementById("section13M3");
        PositionTop100(element);
    }

    let section14 = function () {
        let element = document.getElementById("section14M3");
        PositionTop100(element);
    }
